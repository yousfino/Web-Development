...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <ul class="div2">
      ...
      <li><a href="browseAvailPets.php"><p class="side-bar">Browse Available Pets</p></a></li>
    ...
    <div class="give">
      <fieldset class="fieldsetGiveAway">
        <legend><h1 class="h1GiveAway_">Register a Pet</h1></legend>
        <div class="form">
          <form>
            <label>Breed of Dog or Cat (If Mixed Breed, Enter Each Breed Separated by a Comma)</label>
            <input type="text" id="breedOfDogOrCat"/>
            <br /><br />
            <label>Age Range of the Pet</label>
            <select id="ageRange">
              <option>Please select</option>
              <option>0 to 3 Years</option>
            ...
            <label>Male</label>
            <input type="radio" name="petGender" class="petGender"/>
            <label>&nbsp; &nbsp; Female</label>
            <input type="radio" name="petGender" class="petGender"/>
            <br /><br />
            <label>Does the Pet Get Along with Other Dogs?</label>
            <select id="getAlongDog">
              <option>Please select</option>
              <option>Yes</option>
              <option>No</option>
            ...
            <br /><br />
            <label>Does the Pet Get Along with Other Cats?</label>
            <select id="getAlongCat">
              <option>Please select</option>
              <option>Yes</option>
              <option>No</option>
              <option>I Don't Know</option>
            ...
            <br /><br />
            <label>Is the Pet Suitable for a Family with Small Children?</label>
            <select id="suit">
              <option>Please select</option>
              <option>Yes</option>
              <option>No</option>
            ...
            <br /><br />
            <label>Please Use the Following Text Box to Tell Us More About Your Pet (Optional)</label>
            <br /><br />
            <textarea rows="5" cols="50"></textarea>
            <br /><br /><br />
            <label>What is the Full Name of the Current Owner of the Pet?</label>
            <input type="text" id="fullName"/>
            <br /><br />
            <label>What is the E-mail Address of the Current Owner of the Pet?</label>
            <input type="email" id="em"/>
            <br /><br /><br />
            <input type="button" value="Submit" class="button" onclick="submitValidate()"/>
