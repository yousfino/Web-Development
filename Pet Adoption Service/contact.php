  ...
  <body>
    ...
    <ul class="div2">
      ...
      <fieldset class="fieldsetContact">
        <legend class="legendContact">Our Contact Information</legend>
        <br /><br /><br />
        <span class="span1">Student Name, ID: Youssef Alsheghri, 401 080 14</span>
        <br /><br />
        <span class="span1">Email: <a href="mailto:youssef.alsheghri@gmail.com">youssef.alsheghri@gmail.com</a></span>
        <br /><br />
        <span class="span1">Phone Number: +1 (438) 820-9481</span>
      </fieldset>
